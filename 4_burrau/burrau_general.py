...
from static_plot_burrau import static_plots
from live_plot_burrau import live_plots


#Main function. Must be run from _impl (implementation) scripts.
def main(masses, x, vx, y, vy, z, vz, t, method=SOLVE_IVP, plot_step=1, livePlot=False, regPlot=True, regPlot_coordToTime="x", output_file="_output.csv", output_graph="_output.png", bodies_names=None, top_view=True, input_file=None, initial_positions_in_legend=True, regPlot_energyToTime=True, regPlot_3Dplot=True):
    """
    ...
    if livePlot:
        live_plots(body_count, plot_step,top_view,t,x,y,z)
