...
from static_plot_tools import static_plots
...
def main(masses, x, vx, y, vy, z, vz, t, method=SOLVE_IVP, plot_step=1, livePlot=False, 
         regPlot=True, regPlot_coordToTime="x", output_file="_output.csv", output_graph="_output.png", 
         bodies_names=None, top_view=True, input_file=None, initial_positions_in_legend=True, 
         regPlot_energyToTime=True, regPlot_3Dplot=True, live_plot_t_step=10000):
    """
    ...
    live_plot_t_step: int
        How many time steps to skip between each live plot frame
    """
    ...
    if input_file:
        ...
        [x,vx,y,vy,z,vz]=ode_solve(method, initial_vars, t, body_count, masses, rtol=1e-10, atol=1e-10)
    ...
    if livePlot:
        live_plots(body_count, plot_step,live_plot_t_step,t,x,y,z, bodies_names)
