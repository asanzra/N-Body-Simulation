...
from universals_7 import UNIVERSE_SIZE

#!!-------------------------------------------!!-------------------------------------------------!!
##############This file expands node_6 to 3d, removing visuals, but is very similar##############
#!!-------------------------------------------!!-------------------------------------------------!!
...
def place_node_inside_node(body_node, place_node):
